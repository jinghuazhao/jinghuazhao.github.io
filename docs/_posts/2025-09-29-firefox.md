...
On 24/4/2026, we have from `module avail ceuadmin/firefox`:
...
On 26/3/2026, we have from `module avail ceuadmin/firefox`:
...
where nightly points to 151.0a1.
...
where nightly points to 148.0a1 on 19/12/2025.

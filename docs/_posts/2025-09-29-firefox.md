...
As of 19/12/2025, we have from `module avail ceuadmin/firefox`:

```
--------------------------------------------------- /usr/local/Cluster-Config/modulefiles ----------------------------------------------------
ceuadmin/firefox/60.5.1-1.el7  ceuadmin/firefox/146.0.1  ceuadmin/firefox/148.0a1  ceuadmin/firefox/nightly
```

where nightly actually points to 148.0a1.

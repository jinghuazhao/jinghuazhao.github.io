...
3. Start RStudio (through the rstudio command).
4. library(shiny)
5. runApp()

Note that steps 4 & 5 are within RStudio, and it is assumed that the required R packages (shiny, gap, survminer) are installed.
